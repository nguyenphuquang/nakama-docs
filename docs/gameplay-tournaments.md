...
This document outlines the design of tournaments for Itme-platform server. It covers the rules for how players find tournaments, which ones they can join, when they're allowed to submit scores, and how rewards are distributed when the tournament ends.
